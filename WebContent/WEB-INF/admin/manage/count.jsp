...
.manage-count-search .form-group {
	margin-right: 30px;
}
.manage-count-search-btn {
	width: 100px;
	height: 34px;
...
<body>
<div class="container manage-count-container">
	<!-- <div class="row clearfix">
		...
		<div class="row clearfix">
			<div class="col-md-12 column">
				<div class="btn-group btn-group-lg manage-count-search" style="text-align:center">
					...
					<button type="button" class="btn btn-block btn-primary btn-default manage-count-search-btn" id="show">查询</button>
				</div>
			</div>
		</div>
